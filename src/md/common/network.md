...
![](http://images.hellocode.top/cHS0Bt.png)

> 当使用电路交换来传送计算机数据时, 其线路的传输效率往往很低。

### 3.2 分组交换

![](http://images.hellocode.top/cHa3hq.png)
...
![](http://images.hellocode.top/cHB92t.png)
...
>
> <img src="http://images.hellocode.top/cHrFAg.png" alt="大型机" style="zoom:50%;" />
...
![8](http://images.hellocode.top/8.3kyea9o0f1y0.png)
...
![9](http://images.hellocode.top/9.18qe7kk628jk.png)
...
![11](http://images.hellocode.top/11.7jg9trjr19c0.png)

#### 3. 五层协议体系结构

结合了 OSI 和 TCP/IP 的特点，一般用于学习。

![10](http://images.hellocode.top/10.6tklu3mmr7c0.png)
...
![12](http://images.hellocode.top/12.2ax7qe9se84.png)



### 6.3 计算机网络体系结构分层思想举例

![1](http://images.hellocode.top/1.9p63ey33olk.jpg)
...
![1](http://images.hellocode.top/1.4woox10eux60.png)
...
![](http://images.hellocode.top/2.3avcyll0vd40.png)
...
![4](http://images.hellocode.top/4.4185qagvpxu0.png)
...
![2-1](http://images.hellocode.top/2-1.6szqcx8du700.png)

## 2. 物理层下面的传输媒体

![2-2](http://images.hellocode.top/2-2.42613wqcz0q0.png)
...
![2-3](http://images.hellocode.top/2-3.13dwbapop3hc.png)
...
![2-4](http://images.hellocode.top/2-4.3x2zi4moxp00.png)
...
![2-5](http://images.hellocode.top/2-5.73qli229xks0.png)
...
![2-6](http://images.hellocode.top/2-6.6kq2puyj6uw0.png)
...
![2-7](http://images.hellocode.top/2-7.46knmkk9zk40.png)

### 4.2 码元

码元：在使用时间域的波形表示数字信号时,代表不同 **离散数值的基本波形**。

![2-8](http://images.hellocode.top/2-8.46qrecmq5um0.png)

### 4.3 传输媒体与信道的关系

传输媒体不等同于信道，对于单工通信，传输媒体只有一条 **发送信道或者接收信道**；对于半双工和全双工传输，则包含两条信道；如果使用 **信道复用** 技术，则可以包含多条信道。

![2-9](http://images.hellocode.top/2-9.2gxv9ho4lr60.png)

### 4.4 信道复用技术

![信道复用技术](http://images.hellocode.top/%E4%BF%A1%E9%81%93%E5%A4%8D%E7%94%A8%E6%8A%80%E6%9C%AF.1ifqtkrn9bmo.png)

### 4.5 常用编码

![2-10](http://images.hellocode.top/2-10.1opitsaiihvk.png)

### 4.6 基本调制方法

基本调制方法：调幅、调频、调相

![2-11](http://images.hellocode.top/2-11.2xghqcoe0tg0.png)

### 4.7 混合调制

**正交振幅调制**：通常情况下，相位和振幅可以结合起来一起调制，称为正交振幅调制 QAM。

![2-12](http://images.hellocode.top/2-12.1bxefanjzb40.png)

### 4.8 混合调制举例：正交振幅调制

![2-13](http://images.hellocode.top/2-13.193zdnz65lhc.png)
...
![2-14](http://images.hellocode.top/2-14.glealc1ccu0.png)

### 5.2 奈氏准则

![2-15](http://images.hellocode.top/2-15.7fl55rgwsio0.png)
...
![2-16](http://images.hellocode.top/2-16.2mp8es8zbbm0.png)
...
![2-17](http://images.hellocode.top/2-17.bnv6xoj47rk.png)
...
![3-1](http://images.hellocode.top/3-1.5ea3zzg868g0.png)
...
![](http://images.hellocode.top/3-2.vvt6v0jxdpc.png)

#### 2. 差错检测

接收方主机收到帧后，通过检错码和检错算法，就可以判断出帧在传输过程中是否出现了了误码。

![3-3](http://images.hellocode.top/3-3.6soswamch480.png)
...
![3-4](http://images.hellocode.top/3-4.5nykph0hbik0.png)
...
![3-6](http://images.hellocode.top/3-6.240tmjjr18jk.png)
...
![3-5](http://images.hellocode.top/3-5.1k0uqz9x8dz4.png)
...
![](http://images.hellocode.top/3-9.156vth7bfmao.png)

2）**并不是每一种数据链路层协议的帧都包含帧定界标志。** 例如，以太网MAC帧。而且以太网V2的MAC帧还有帧间间隔，规定为 96 比特时间。

![](http://images.hellocode.top/3-10.7iclb7mbp4c0.png)

### 2.2 透明传输

**透明传输**：是指数据链路层对上层交付的传输数据没有任何限制，就好像数据链路层不存在一样。

![3-7](http://images.hellocode.top/3-7.g2e5zs24zs8.png)

**例题**

![3-11](http://images.hellocode.top/3-11.3u07pmbp2fc0.png)

### 2.3 提高帧传输效率

![3-8](http://images.hellocode.top/3-8.652gtybl8vo0.png)
...
![3-12](http://images.hellocode.top/3-12.2jhqh0ugkrs0.png)
...
![3-13](http://images.hellocode.top/3-13.3075ixh62600.png)
...
![3-17](http://images.hellocode.top/3-17.35cd446mr900.png)

**2）生成多项式**

![3-18](http://images.hellocode.top/3-18.2nsiqx5fa7o0.png)

#### 2. 举例

**1）发送方处理**

![3-14](http://images.hellocode.top/3-14.2zqhaxf0kag.png)

**2）接收方处理**

![3-15](http://images.hellocode.top/3-15.wl7q2nrrjo0.png)

### 3.4 本节总结

![3-16](http://images.hellocode.top/3-16.1fgm6l28lvpc.png)
...
![3-21](http://images.hellocode.top/3-21.6srus6nv06w0.png)
...
![3-22](http://images.hellocode.top/3-22.49czoiacbse0.png)

#### 2. 超时重传机制

![3-23](http://images.hellocode.top/3-23.6c40g10nhx80.png)
...
![3-25](http://images.hellocode.top/3-25.56vynwvuyts0.png)

#### 4. 确认分组ACK迟到：确认分组也需要编号

> 对于PPP信道的数据链路层实现停止-等待协议，往返时间固定，不需要给确认分组编号。

![3-26](http://images.hellocode.top/3-26.77zevrzgjbk0.png)
...
![3-27](http://images.hellocode.top/3-27.4dtomysg9440.png)

**计算举例**

![3-28](http://images.hellocode.top/3-28.1gm2i4d9hkhs.png)
...
![3-29](http://images.hellocode.top/3-29.37dfa94s6lq0.png)
...
![3-30](http://images.hellocode.top/3-30.qk3ngibc10w.png)
...
![3-31](http://images.hellocode.top/3-31.3uu8ugznfci0.png)
...
![3-32](http://images.hellocode.top/3-32.22n3jtl2zm9s.png)
...
![3-33](http://images.hellocode.top/3-33.5cbbcv2dz4o0.png)

##### （4）$W_T$超过其上限7

若$W_T$超过取值范围，例如$W_T=8$，会出现什么情况?

![3-34](http://images.hellocode.top/3-34.1q4q2no3jb34.png)
...
![3-35](http://images.hellocode.top/3-35.5ndsrweq16w0.png)

**例题**

![3-36](http://images.hellocode.top/3-36.3dv2v8n50o80.png)
...
![3-37](http://images.hellocode.top/3-37.28iehhil08n4.png)

##### 1）选择重传协议发送窗口与接收窗口应满足的条件

![3-38](http://images.hellocode.top/3-38.7igj3l4ex100.png)

##### 2）若发送窗口取值超过限制

如果发送窗口和接收窗口超过了取值范围，就会使 **接收方无法区分新、旧数据分组**，进而出现 **分组重复** 这种差错。

![3-39](http://images.hellocode.top/3-39.7b7sq1249o00.png)

#### 3. SR协议总结

![3-40](http://images.hellocode.top/3-40.2oa58zu4dq20.png)
...
![3-41](http://images.hellocode.top/3-41.3hf6j05r2sc0.png)
...
![3-42](http://images.hellocode.top/3-42.789r2rd22pk0.png)
...
![3-43](http://images.hellocode.top/3-43.1m5k2nwuq1s0.png)

### 5.2 点对点协议PPP的帧格式

![3-44](http://images.hellocode.top/3-44.181dut81ll5s.png)
...
![3-46](http://images.hellocode.top/3-46.3ev0onisi7c0.png)

#### 2. 比特填充法

![3-47](http://images.hellocode.top/3-47.5s99frf73qc0.png)

### 5.4 差错检测

![3-48](http://images.hellocode.top/3-48.1oyab118igu8.png)

### 5.5 工作状态

![3-49](http://images.hellocode.top/3-49.m026a75vdvk.png)
...
![3-50](http://images.hellocode.top/3-50.3v43beoi02s0.png)

### 6.2 媒体接入技术分类

![3-51](http://images.hellocode.top/3-51.48hs0cfh6gs0.png)
...
![3-52](http://images.hellocode.top/3-52.2yyxyctbj4w0.png)

#### 1. 频分复用 FDM

频分复用的所有用户 **同时占用不同的频带资源** 并行通信。

![3-53](http://images.hellocode.top/3-53.20kd4ckp3ue8.png)

#### 2. 时分复用 TDM

时分复用的所有用户在 **不同的时间占用同样的频带宽度** 。

![3-54](http://images.hellocode.top/3-54.3s4o1moyxnq0.png)

#### 3. 波分复用 WDM

![3-55](http://images.hellocode.top/3-55.4qk4s4d1on00.png)
...
![3-56](http://images.hellocode.top/3-56.6t4cylgwngs0.png)

##### （3）码片的应用举例

![3-57](http://images.hellocode.top/3-57.6b04u9kaw7k0.png)

![3-58](http://images.hellocode.top/3-58.3zgqxwlnudk0.png)

**解析**

![3-59](http://images.hellocode.top/3-59.1b2aarwjffa8.png)

其他选项类似计算。（A发送1；B发送0；C未发送；D发送1）

![3-60](http://images.hellocode.top/3-60.71qtevi8ibk0.png)

**解答**

![3-61](http://images.hellocode.top/3-61.79nkp43g98w0.png)
...
![3-62](http://images.hellocode.top/3-62.ko0cxzbqk4g.png)
...
![3-63](http://images.hellocode.top/3-63.35f4d7a5g7g0.png)
...
![3-66](http://images.hellocode.top/3-66.13ke9jqzfmow.png)
...
![3-67](http://images.hellocode.top/3-67.100e5e729s1c.png)
...
![3-68](http://images.hellocode.top/3-68.rb6g1xohoeo.png)

#### 6. 截断二进制指数退避算法

![3-69](http://images.hellocode.top/3-69.66m74vavijc0.png)

#### 7. 信道利用率

##### （1）一般信道利用率

![3-71](http://images.hellocode.top/3-71.47gnnn69sim0.png)

##### （2）极限信道利用率

发送一帧所用时间为 $T_0+\tau$，帧本身发送时间为 $T_0$，则信道利用率计算公式如下  

![3-72](http://images.hellocode.top/3-72.6h9z8xxzyy0.png)

![3-70](http://images.hellocode.top/3-70.1zfp5os3jtc0.png)

#### 8. 帧发送/接收流程

##### （1）帧发送流程

![3-73](http://images.hellocode.top/3-73.7l7dzeaaid40.png)

##### （2）帧接收流程

![3-74](http://images.hellocode.top/3-74.6oqwz8w34d00.png)

#### 9. 测试题

![3-75](http://images.hellocode.top/3-75.pbat88dw4dc.png)


![3-76](http://images.hellocode.top/3-76.5noc24hijxs0.png)

<font size=4 color=red>解析</font>

**（1）最短时间：**

![3-77](http://images.hellocode.top/3-77.6vjsnp5z58w0.png)
**（2）最长时间：**

![3-78](http://images.hellocode.top/3-78.7cbrvg5bbqg0.png)
...
![3-79](http://images.hellocode.top/3-79.47v16lx74240.png)
...
![3-80](http://images.hellocode.top/3-80.ezsn5iuuvzs.png)

<font size=4 color=blue>第 1 位字节的低位为 1、3、5、7、9、B、D，则为多播地址，48 位全为 1 时，则为广播地址。</font>

![3-81](http://images.hellocode.top/3-81.1szmag9p42ow.png)
...
![3-82](http://images.hellocode.top/3-82.7kltoy6kmqc0.png)
...
![3-83](http://images.hellocode.top/3-83.2n84zt5t6fc0.png)

#### （2）广播地址

主机B将本机地址填入源地址，将 `FF-FF-FF-FF-FF-FF` 广播地址填入目的地址，构成广播帧。

![3-84](http://images.hellocode.top/3-84.4vs3mdbc74i0.png)

#### （3）多播地址

主机A发送含有多播地址的多播帧，其他主机根据自己的多播组列表，判断是否接收帧。

![3-85](http://images.hellocode.top/3-85.5q96pqot6d80.png)
...
![3-86](http://images.hellocode.top/3-86.1rgrw1lfm5s0.png)

### 8.1 从网络体系结构看IP地址与MAC地址

IP 地址属于网络层，MAC 地址属于数据链路层。

![3-87](http://images.hellocode.top/3-87.5olppozu4ew0.png)
...
![3-88](http://images.hellocode.top/3-88.cfqcetmeug8.png)

<font size=4 color=orange>暂且这么认为</font>：H1知道应该把数据包传给R1，由R1帮其把数据包转发出去。H1知道R1相应接口的IP地址为IP3，但不知道其对应的MAC地址是什么! 

### 8.3 测试题

![3-89](http://images.hellocode.top/3-89.58buq2ceu340.png)
...
![3-92](http://images.hellocode.top/3-92.1nsjcorozveo.png)

- ARP 协议：由 IP 地址获取 MAC 地址的一种协议。

![3-90](http://images.hellocode.top/3-90.6k578pmwods0.png)
...
![3-91](http://images.hellocode.top/3-91.557pb0kwgn80.png)
...
![3-93](http://images.hellocode.top/3-93.43wjzvoyiwy0.png)
...
![3-94](http://images.hellocode.top/3-94.5mnkqpbsz3s.png)
...
![3-98](http://images.hellocode.top/3-98.2arqeu089cys.png)

### 10.5 集线器和交换机的区别

#### （1）单播（一个）

![3-99](http://images.hellocode.top/3-99.55g65f5lovg0.png)

#### （2）广播

![3-100](http://images.hellocode.top/3-100.3mg5p0gvn200.png)

#### （3）单播（两个）

两个同时进行的单播，对于集线器，会发生碰撞。而对于交换机，则不会产生碰撞。

![3-101](http://images.hellocode.top/3-101.3a9p4kvm6ok0.png)
...
![3-102](http://images.hellocode.top/3-102.6vv4arwseyg0.png)
...
![3-103](http://images.hellocode.top/3-103.pnszm7tr940.png)
...
![](http://images.hellocode.top/3-104.345c2ut9tcm0.png)

<font size=5 color=red>解析</font>

![3-105](http://images.hellocode.top/3-105.1ayg20fghrds.png)

## 12. 以太网交换机的生成树协议STP

### 12.1 背景

![3-106](http://images.hellocode.top/3-106.cbnvap4f5h.png)
...
![3-108](http://images.hellocode.top/3-108.6gbqu279nyw0.png)

但是 <font size=4 color=blue>网络中会频繁出现广播信息</font>，于是就需要划分广播域。

一种方法是使用 **路由器**，路由器工作在 **网络层**，**默认情况下不对广播数据包进行转发**。

![3-109](http://images.hellocode.top/3-109.77efv0entx40.png)
...
![3-110](http://images.hellocode.top/3-110.43m49ag3f240.png)
...
![3-111](http://images.hellocode.top/3-111.68elddwjhu80.png)
...
![3-112](http://images.hellocode.top/3-112.29fs52xkk44k.png)
...
![3-113](http://images.hellocode.top/3-113.3vsphrqmy820.png)

<font size=4 color=blue>测试题</font>

![3-114](http://images.hellocode.top/3-114.6t9rx42nid40.png)

<font size=4 color=red>解答</font>

![3-115](http://images.hellocode.top/3-115.2oajfghyk2u0.png)

##### （3）Hybrid 端口（了解）

![3-116](http://images.hellocode.top/3-116.4zlnkmsdy8c0.png)
