...
import { checkStyle, convertFrontmatter, convertThemeOptions, } from "./compact/index.js";
...
legacy = false) => (app) => {
    ...
    const { hotReload = isDebug, plugins = {}, hostname, iconAssets, iconPrefix, addThis, backToTop, sidebarSorter, notice, ...themeOptions } = legacy
    ...
    return {
        ...
        extendsPage: (page) => {
            ...
            extendsPage(app, page, themeConfig, status, hotReload || app.env.isBuild);
        },
